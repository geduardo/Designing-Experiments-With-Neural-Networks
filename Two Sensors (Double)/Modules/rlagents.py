...
class DoubleDQN:
    def __init__(self, iterations, input_size, output_size, learning_rate=0.01, discount=0, exploration_rate=1):
        self.learning_rate = learning_rate
    ...
    def get_Q(self, state): # To predict the Q values for each action for a given state
        return self.model.predict(state)
