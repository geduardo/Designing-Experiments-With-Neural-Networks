...
class Two_Neurons(object):
    def __init__(self, input_size, learning_rate=0.001):
        """ This class is just a two-layer Keras neural network to process the
        data taken by the experimenter to produce a single output. Two neuron
        with one single hidden layer.
    ...
    def build_model(self):
        ...
        *input_sizex2x1* fully connected sequential network.
